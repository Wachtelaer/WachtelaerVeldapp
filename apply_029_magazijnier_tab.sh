...
echo "Wachtelaer Veldapp - Magazijn tab + magazijnier-rol toepassen..."

rm -f "app/(tabs)/meer/magazijn.tsx"

mkdir -p "app/(tabs)"
cat > "app/(tabs)/_layout.tsx" <<'WACHTELAER_EOF_MARKER'
...
cat > "app/(tabs)/magazijn/_layout.tsx" <<'WACHTELAER_EOF_MARKER'
import { Stack } from 'expo-router';

export default function MagazijnStackLayout() {
...
echo "Klaar. Vergeet niet: voer supabase/migrations/0012_magazijnier_rol.sql uit in de Supabase SQL editor."
