...
echo "Wachtelaer Veldapp - Magazijnier als volwaardige rol toepassen..."

mkdir -p "supabase/migrations"
cat > "supabase/migrations/0013_magazijnier_als_rol.sql" <<'WACHTELAER_EOF_MARKER'
...
mkdir -p "lib"
cat > "lib/theme.ts" <<'WACHTELAER_EOF_MARKER'
...
echo "Klaar. Voer nu de inhoud van supabase/migrations/0013_magazijnier_als_rol.sql uit in de Supabase SQL editor."
